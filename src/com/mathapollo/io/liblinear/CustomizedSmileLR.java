package com.mathapollo.io.liblinear;
...
public class CustomizedSmileLR implements SoftClassifier<double[]> {
    ...
    public static class Trainer extends ClassifierTrainer<double[]> {
        ...
        @Override
        public CustomizedSmileLR train(double[][] x, int[] y) {
            return new CustomizedSmileLR(x, y, lambda, tol, maxIter);
        }
    }
     ...
     */
    public CustomizedSmileLR(double[][] x, int[] y) {
        this(x, y, 0.0);
    }
     ...
     */
    public CustomizedSmileLR(double[][] x, int[] y, double lambda) {
     ...
     * @param maxIter the maximum number of iterations.
     */
    public CustomizedSmileLR(double[][] x, int[] y, double lambda, double tol, int maxIter) {
    ...
    public double predict2classProbability(double[] x)
    {
    	return PredictProbility_for2class(x, null);
    }
    @Override
    ...
    public double PredictProbility_for2class(double[] x, double[] posteriori)
    {
